  ...
  return (
    <div className='relative w-full h-full rounded-2xl overflow-hidden hero-container'>
      ...
      <div className="relative z-10 w-full h-full">
        ...
        <button className='text-white text-lg bg-violet-800 px-8 py-2 rounded-4xl absolute bottom-6 right-10 border-none cursor-pointer hover:bg-violet-900'>Quick add event</button>
      </div>
    </div>
  )
}
